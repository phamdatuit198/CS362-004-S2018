...
int main(){
	...
	cardEffect(smithy, firstChoice, secondChoice, thirdChoice, &gState, handpos, &bonus);
	...
	resultFromCheck = checkResult(gState.deckCount[player1],tempState.deckCount[player1]-3);
	if(resultFromCheck == 1)
		failTotal++;
